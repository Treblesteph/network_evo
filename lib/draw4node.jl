...
function draw4node(reps, acts, envs, gates)
  ...
  function drawall()
    ...
    compose(context(),
           ...
           (context(), drawgeneric(canvas, c1, c2, rad, rad)))
  end
...
drawnreps[1] = ([(0.19, 0.28), (0.19, 0.32)]) # 1 to 1
drawnreps[2] = ([(0.42, 0.25), (0.42, 0.29)]) # 2 to 1
drawnreps[3] = ([(0.415, 0.405), (0.445, 0.375)]) # 3 to 1
drawnreps[4] = ([(0.31, 0.42), (0.35, 0.42)]) # 4 to 1
drawnreps[5] = ([(0.58, 0.31), (0.58, 0.35)]) # 1 to 2
drawnreps[6] = ([(0.81, 0.28), (0.81, 0.32)]) # 2 to 2
drawnreps[7] = ([(0.71, 0.42), (0.75, 0.42)]) # 3 to 2
drawnreps[8] = ([(0.595, 0.415), (0.625, 0.445)]) # 4 to 2
drawnreps[9] = ([(0.555, 0.625), (0.585, 0.595)]) # 1 to 3
drawnreps[10] = ([(0.65, 0.58), (0.69, 0.58)]) # 2 to 3
drawnreps[11] = ([(0.81, 0.68), (0.81, 0.72)]) # 3 to 3
drawnreps[12] = ([(0.58, 0.71), (0.58, 0.75)]) # 4 to 3
drawnreps[13] = ([(0.25, 0.58), (0.29, 0.58)]) # 1 to 4
drawnreps[14] = ([(0.375, 0.555), (0.405, 0.585)]) # 2 to 4
drawnreps[15] = ([(0.42, 0.65), (0.42, 0.69)]) # 3 to 4
drawnreps[16] = ([(0.19, 0.68), (0.19, 0.72)]) # 4 to 4
...
function drawacts(acts, c1, c2, canvas, rad)
  ...
  drawnacts[14] = ([(0.38, 0.58), (0.39, 0.54), (0.42, 0.57)]) # From 2 to 4.
